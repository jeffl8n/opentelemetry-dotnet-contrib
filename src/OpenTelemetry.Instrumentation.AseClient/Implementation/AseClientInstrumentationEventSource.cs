...
/// </summary>
[EventSource(Name = "OpenTelemetry-Instrumentation-AseClient")]
internal sealed class AseClientInstrumentationEventSource : EventSource
{
    public static AseClientInstrumentationEventSource Log = new();
